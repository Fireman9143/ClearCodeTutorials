...
No global enums or data files. These enums are created within each associated file, such as plant.gd
...
The UI for plant management is super large.  Double checking the sizes and trying to troubleshoot to more appropriate menu size.
